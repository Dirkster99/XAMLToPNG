namespace XAMLtoPNG
{
    ...
    class Params
    {
        ...
        public static string CopyInputfile = "-CopyInput";
        ...
        + "\n"
        + string.Format("  {0} Copy input file to destionation folder\n", Params.CopyInputfile);
        ...
        /// <summary>
        /// Gets whether input files should be copied to destination directory or not.
        /// </summary>
        public bool CopyInput { get; private set; }
        ...
        static public int ParseCmdLine(string[] args, out Params progParams, out string strError)
        {
            ...
            for (int i = 0; i < args.Length; i++)
            {
                ...
                if (args[i].ToUpper() == CopyInputfile.ToUpper())
                {
                    progParams.CopyInput = true;
                    continue;
                }
